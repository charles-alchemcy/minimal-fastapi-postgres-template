[![Live example](https://img.shields.io/badge/live%20example-https%3A%2F%2Fminimal--fastapi--postgres--template.charles-alchemcy.pl-blueviolet)](https://minimal-fastapi-postgres-template.charles-alchemcy.pl/)
[![License](https://img.shields.io/github/license/rafsaf/minimal-fastapi-postgres-template)](https://github.com/charles-alchemcy/minimal-fastapi-postgres-template/blob/main/LICENSE)
...
_Check out online example: https://minimal-fastapi-postgres-template.charles-alchemcy.pl, it's 100% code used in template (docker image) with added my domain and https only._
...
1. Docs
    ...
    app = FastAPI(
        ...
        version="6.1.0",
        description="https://github.com/charles-alchemcy/minimal-fastapi-postgres-template",
